...
def get_house(Project_ID):
    ...
    json_list = housing_data['Housing Data']
...
def update_house(Project_ID):
    ...
    list = [x for (x, i) in enumerate(housing_data['Housing Data']) if i['Project ID'] == Project_ID]

    housing_data['Housing Data'][list[0]]['Address'] = new_address
    housing_data['Housing Data'][list[0]]['Zip Code'] = new_zip
    housing_data['Housing Data'][list[0]]['Unit Type'] = new_unit_type
    housing_data['Housing Data'][list[0]]['Tenure'] = new_tenure
    housing_data['Housing Data'][list[0]]['City Amount'] = new_city_amount
    housing_data['Housing Data'][list[0]]['Longitude'] = new_longitude
    housing_data['Housing Data'][list[0]]['Latitude'] = new_latitude
    housing_data['Housing Data'][list[0]]['Property Manager Phone Number'] = new_manager_number
    housing_data['Housing Data'][list[0]]['Property Manager Email'] = new_manager_email
...
def delete_house(Project_ID):
    ...
    housing_data['Housing Data'].pop(list[0])
    rd_raw.set('Housing Data', json.dumps(housing_data, indent=2))
